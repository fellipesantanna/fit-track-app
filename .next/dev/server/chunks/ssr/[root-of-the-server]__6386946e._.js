...
const sessionsApi = {
   ...
   * GET ALL SESSIONS FROM USER
   ============================================================================ */ async getAll () {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sessions").select("*").order("created_at", {
            ascending: false
        });
   ...
   * CREATE A SESSION (PR3 — COM TODOS EXERCÍCIOS E SETS)
   ============================================================================ */ async create (dto) {
        // 1) Criar sessão
        const { data: session, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sessions").insert({
        ...
        for (const ex of dto.exercises){
            const { data: dbEx, error: exErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("session_exercises").insert({
            ...
            for (const set of ex.sets){
                const { error: setErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sets").insert({
   ...
   * Carregar sessões detalhadas
   ============================================================ */ async function load() {
        ...
        try {
            ...
            const detailed = [];
            for (const s of base){
                detailed.push(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sessionsApi"].getById(s.id));
            }
            setList(detailed);
        } finally{
            setLoading(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6386946e._.js.map